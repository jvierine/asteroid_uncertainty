...
epoch_et0 = spice.str2et("2025-01-01T00:00:00")
 ...
 #   print(earth_flattening)
  ...
  #  print(pos)
   ...
   # print(obs_pos)
    ...
    state = spice.sxform("ITRF93", "J2000", et)
   # print(state)
...
#    print("Observer position in J2000 frame (km):", observer_j2000)
 ...
 #   print(epoch_et)
    kep_elements = [
        kep[0],     # Semi-major axis in km (e.g., 2 AU ≈ 300 million km)
        kep[1],           # Eccentricity
    ...
    return(observer_j2000,state_asteroid)
